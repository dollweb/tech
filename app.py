...
with col1:
   ...
   with st.form("form1"):
      ...
      T_46_temp = st.text_input('기술인력수: ')
      T_50_temp = st.text_input('특허등록수: ')
      T_80_temp = st.text_input('벤처+이노비즈: ')
      T_83_temp = st.text_input('매출액2년평균: ')
      T_88_temp = st.text_input('영업이익3년평균: ')
      T_106_temp = st.text_input('연구소디자인더미: ')
      T_110_temp = st.text_input('3개년개발비더미: ')
